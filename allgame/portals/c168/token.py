# -*- coding: utf-8 -*-
"""C168 — đọc / kiểm tra token lobby qua hall API."""
...
PORTAL_ID = "c168"
_DEFAULT_HALL_ORIGIN = "https://af861c.c168f.com"
...
class C168TokenChecker:
    ...
    def _build_context(self, account: dict[str, Any]) -> dict[str, Any]:
        ...
        sitecode = _first_non_empty(ctx, ("sitecode", "site_code"), "2865")
            ...
            "callContext": json.dumps(
                {
                    ...
                    "stack": ["C168TokenChecker.test_token (allgame)"],
                },
                ensure_ascii=False,
                separators=(",", ":"),
            ),
